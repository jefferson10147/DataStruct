 ...
 *	tipo Grafo, que puede ser, dirigido o no, y adem�s, puede ser,
...
class Grafo {
	...
	public:
		...
		bool isDirigido() const; // devuelve determinaci�n acerca de si el Grafo es dirigido o no
		bool isPonderado() const; // devuelve determinaci�n acerca de si el Grafo es ponderado o no
