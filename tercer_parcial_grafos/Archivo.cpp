 ...
 *	@since 1.0
 *	@return	true apertura correcta, false error l�gico
 */ 
bool Archivo::abrir() 
{
...
/**
 *	@brief	crea un nuevo archivo con el nombre asociado y lo
 * lo apertura para escritura, en caso de que un archivo con 
 *	el mismo nombre exista, se eliminara todo su contenido
 *	@since 1.1
 *	@return	true creaci�n correcta, false error l�gico
 */ 
bool Archivo::crear()
{
	// crea el archivo con el nombre asociado y lo apertura para escritura
